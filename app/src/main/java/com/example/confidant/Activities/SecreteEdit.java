...
public class SecreteEdit extends AppCompatActivity {
    TextInputEditText nameHome, passHome, descHome, confPass, usernameHome;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Toast.makeText(getApplicationContext(),String.valueOf(index),Toast.LENGTH_SHORT).show();
        ...
        usernameHome = findViewById(R.id.editName_username);
        ...
        usernameHome.setText(secreteFetch.getUsername());
        ...
        builderConfirm.setTitle("Update Confirm")
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int ii) {
                        ...
                        Secrete secrete = new Secrete(name.toString(), base64pass, desc.toString(), usernameHome.getText().toString());
        ...
        editButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else if(TextUtils.isEmpty(usernameHome.getText()))
                    usernameHome.setError("Username Required");
                else {
